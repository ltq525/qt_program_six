...
int MoveGenerator::GetMoveList(char ourColor , move_t* moveList, char board[][GRID_NUM])
{
...
//有棋子的地方扩展格，对map操作
int MoveGenerator::InitValuableSpace(char board[][GRID_NUM]) {
...
void MoveGenerator::add_new_pos_for_two(char x, char y)
{
    pos_t pos ;
    pos.x = x;
    pos.y = y;
...
void MoveGenerator::add_new_pos_for_two_special(char x, char y)
{
    pos_t pos ;
    pos.x = x;
    pos.y = y;
...
//有棋子的地方扩展3格
bool MoveGenerator::extend_pos(char x, char y, char board[][GRID_NUM])
{
    int i,j;
    int count;
...
int MoveGenerator::set_score( char ourColor , int step , move_one_t moveList[], char board[][GRID_NUM] )
{
    int count = 0 , score = 0;
    int i,j;
...
int MoveGenerator::sort_merge(move_one_t list[],move_one_t listOne[],int oneN,move_one_t listTwo[],int twoN)
{
    int index[361] = {0};
...
int MoveGenerator::set_score_single ( char ourColor , int x , int y , int step, char board[][GRID_NUM] )
{
    int score = 0;
    clock_t beg,end;
    beg = clock();
...
int MoveGenerator::set_by_direction1 ( char color , int x , int y , int step, char board[][GRID_NUM] )
{
...
int MoveGenerator::set_by_direction2 ( char color , int x , int y , int step, char board[][GRID_NUM] )
{
...
// Set score by horizon direction.//水平方向估值
int MoveGenerator::set_by_direction3 ( char color , int x , int y , int step, char board[][GRID_NUM] )
{
...
int MoveGenerator::set_by_direction4 ( char color , int x , int y , int step, char board[][GRID_NUM] )
{
    int self , enemy , highLevelx , lowLevelx , highLevely , lowLevely , i , j , connectCountUp = 0 , connectCountDn = 0 , OcountUp = 0 , OcountDn = 0 , score = 0 , middleCheck[2] = {0,0} , connectCount = 0 , defSuc = 0 , defVT = 0 , canGoFive = 0 , edgeBlock = 0 , Ocount = 0;

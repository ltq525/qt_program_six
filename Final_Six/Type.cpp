...
void Evaluation::set_situation(char board[][GRID_NUM])
{
    //初始化
    int d[4];//方向表示
...
void Evaluation::set_situation_for_one_direction(int x, int y ,short countx,short county,int dir, char board[][GRID_NUM])
{
